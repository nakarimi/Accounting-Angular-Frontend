...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-bill-bill-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsBillBillComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsBillCuDialogHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsBillBillComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsBillBillComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var BillComponent = /*#__PURE__*/function () {
      function BillComponent(apiService, dialog, toast) {
        ...
        this.displayedColumns = ['bill_number', 'vendor', 'total_price', 'balance', 'due_date', 'status', 'id'];
        this.filterColumns = ['bill_number', 'vendor', 'total_price', 'balance', 'due_date']; // Define all the variable
        ...
        this.vendors = []; // Build the table data source based on table data.
      ...
      _createClass(BillComponent, [{
        ...
        value: function loadItems(elm) {
          ...
          this.loading = true;
          this.bilItems = [];
          this.apiService.retrive('bitm', elm.id).subscribe(function (result) {
          ...
          this.apiService.loadAll('pay').subscribe(function (result) {
            if (result.filter(function (x) {
              ...
              if (confirm('Are sure to delete?')) {
                _this5.apiService["delete"](row.id, 'bil').subscribe(function (result) {
                  _this5.deleteUI(row);
                });
              }
            }
        ...
        key: "findVendor",
        value: function findVendor(id) {
          return this.vendors.filter(function (x) {
            return x.id == id;
          })[0];
        }
      }]);
    ...
    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MatPaginator"], {
      "static": false
    }), __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatPaginator"])], BillComponent.prototype, "paginator", void 0);
    ...
    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSort"], {
      "static": false
    }), __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSort"])], BillComponent.prototype, "msort", void 0);

    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(), __metadata("design:type", Object)], BillComponent.prototype, "bills", void 0);
    ...
    BillComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/bill/bill.component.html"))["default"],
      ...
      /*! ./bill.component.css */
      "./src/app/components/bill/bill.component.css"))["default"]]
    }), __metadata("design:paramtypes", [_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"], _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"], _shared_toast_toast_service__WEBPACK_IMPORTED_MODULE_5__["ToastService"]])], BillComponent);
    ...
    var CuDialog = /*#__PURE__*/function () {
      ...
      _createClass(CuDialog, [{
        ...
        value: function ngOnInit() {
          console.log(this.entity); // Assign Dialog data to new variable.
        ...
        key: "bilOperation",
        value: function bilOperation(data) {
          var _this7 = this;
          ...
          if (data) {
            console.log('update');
            this.apiService.update(data.id, this.billFC.value, 'bil').subscribe(function (result) {
              if (result.error) {
            ...
            this.apiService.create(this.billFC.value, 'bil').subscribe(function (result) {
              if (result.error) {
                console.log(result.error);
              } else {
                _this7.bill = result;
        ...
        value: function getLastInvNum() {
          ...
          this.apiService.loadAll('last_bil').subscribe(function (result) {
            if (result.bill) {
              _this8.bilNumber = 'Bill-' + (result.bill + 1);
            } else {
              _this8.bilNumber = 'Bill-' + 1;
            }

            _this8.billFC.controls['bill_number'].disable();

            _this8.billFC.controls['total_price'].disable();

            _this8.billFC.controls['balance'].disable();
          });
        }
      }, {
        key: "createItem",
        value: function createItem() {
          ...
          this.apiService.create(this.itemsFC.value, 'bitm').subscribe(function (result) {
            if (result.error) {
              _this9.errors = result.error;
            } else {
              _this9.billItems.push(result);

              console.log(_this9.billItems);

              _this9.calTotal();

              _this9.itemSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](_this9.billItems);
        ...
        value: function removeItem(data) {
          ...
          if (confirm('Are sure to delete?')) {
            this.apiService["delete"](data.id, 'bitm').subscribe(function (result) {
              _this10.billItems = _this10.billItems.filter(function (item) {
                return item !== data;
              });
              _this10.itemSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](_this10.billItems);
    ...
    CuDialog = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/bill/cu-dialog.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./bill.component.css */
      "./src/app/components/bill/bill.component.css"))["default"]]
  ...
  /***/
  function srcAppComponentsBillBillModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BillRoutes", function () {
      return BillRoutes;
    });
    /* harmony export (binding) */
    ...
    var _bill_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./bill.component */
    "./src/app/components/bill/bill.component.ts");
    /* harmony import */
    ...
    BillModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
      declarations: [_bill_component__WEBPACK_IMPORTED_MODULE_3__["BillComponent"], _bill_component__WEBPACK_IMPORTED_MODULE_3__["CuDialog"], _bill_component__WEBPACK_IMPORTED_MODULE_3__["SnakComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(BillRoutes)],
      entryComponents: [_bill_component__WEBPACK_IMPORTED_MODULE_3__["CuDialog"], _bill_component__WEBPACK_IMPORTED_MODULE_3__["SnakComponent"]],
      providers: [{
...
//# sourceMappingURL=components-bill-bill-module-es5.js.map