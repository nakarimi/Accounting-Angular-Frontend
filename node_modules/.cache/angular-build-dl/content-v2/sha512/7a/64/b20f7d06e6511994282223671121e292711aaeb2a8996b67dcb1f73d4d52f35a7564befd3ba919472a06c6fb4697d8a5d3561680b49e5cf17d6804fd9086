...
/* harmony import */ var _shared_toast_toast_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/toast/toast-service */ "./src/app/shared/toast/toast-service.ts");
...
let UserComponent = class UserComponent {
    constructor(apiService, toast, router, dialog) {
    ...
    loadUsers() {
        this.apiService.loadAll('users').subscribe((result) => {
    ...
    switchSuperUser(data) {
        ...
        if (confirm(msg)) {
            this.apiService.parUpdate(data.id, { 'is_superuser': !data.is_superuser }, 'users').subscribe(result => {
                this.toast.show('User updated successfully!', { classname: 'bg-info text-light', delay: 2500 });
...
], UserComponent.prototype, "msort", void 0);
UserComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        styles: [__importDefault(__webpack_require__(/*! ./user.component.css */ "./src/app/components/user/user.component.css")).default]
    }),
    __metadata("design:paramtypes", [_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"],
        _shared_toast_toast_service__WEBPACK_IMPORTED_MODULE_3__["ToastService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
        _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"]])
], UserComponent);

let AddUserComponent = class AddUserComponent {
    constructor(apiService, toast, router, dialogRef, _formBuilder) {
        this.apiService = apiService;
        this.toast = toast;
        this.router = router;
    ...
    authentication() {
        this.apiService.registerUser(this.regForm.value).subscribe(result => {
    ...
    checkUsername() {
        ...
        if (username.value && v) {
            ...
            return username.setErrors(r ? { custom: true } : null);
        }
    }
    checkEmail() {
        ...
        if (email.value && v) {
            ...
            return email.setErrors(r ? { custom: true } : null);
        }
    }
...
AddUserComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./adduser.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/user/adduser.component.html")).default,
    }),
    __metadata("design:paramtypes", [_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"],
        _shared_toast_toast_service__WEBPACK_IMPORTED_MODULE_3__["ToastService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
...
UserModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        declarations: [
            ...
            _user_component__WEBPACK_IMPORTED_MODULE_2__["AddUserComponent"]
        ],
        imports: [
...
//# sourceMappingURL=components-user-user-module-es2015.js.map