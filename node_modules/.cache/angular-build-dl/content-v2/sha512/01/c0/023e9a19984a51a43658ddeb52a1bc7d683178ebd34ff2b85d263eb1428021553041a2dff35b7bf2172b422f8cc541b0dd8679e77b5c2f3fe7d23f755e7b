...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-invoice-invoice-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsInvoiceCuDialogHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsInvoiceInvoiceComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsInvoiceInvoiceComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsInvoiceInvoiceComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CuDialog", function () {
      return CuDialog;
    });
    /* harmony export (binding) */
    ...
    var _shared_toast_toast_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var InvoiceComponent = /*#__PURE__*/function () {
      function InvoiceComponent(apiService, dialog, toast) {
        ...
        this.displayedColumns = ['inv_number', 'customer', 'total_price', 'balance', 'due_date', 'status', 'id'];
        this.filterColumns = ['inv_number', 'customer', 'total_price', 'balance', 'due_date']; // Define all the variable
        ...
        this.displayedItemColumns = ['label', 'price', 'quantity', 'total', 'created_at', 'desc'];
        ...
        this.customers = [];
        this.payments = []; // Build the table data source based on table data.
      ...
      _createClass(InvoiceComponent, [{
        ...
        key: "assigning",
        value: function assigning(data) {
          this.invItems = data;
        }
      }, {
        key: "loadItems",
        value: function loadItems(elm) {
          var _this2 = this;

          this.loading = true;
          this.invItems = [];
          this.apiService.retrive('itm', elm.id).subscribe(function (result) {
            _this2.assigning(result);
        ...
        value: function loadInvoices() {
          ...
          this.apiService.loadAll('inv').subscribe(function (result) {
            ...
            _this3.dataSource.sort = _this3.msort;
          }, function (error) {
            console.log(error);
          });
        }
        ...
        value: function openDialog(data) {
          ...
          var dialogRef = this.dialog.open(CuDialog, {
            data: {
              mainData: data,
          ...
          if (data) {
            this.apiService.loadAll('pay').subscribe(function (result) {
              _this4.payments = result;

              if (_this4.payments.filter(function (x) {
                return x.ref_inv == data.id;
              }).length > 0) {
                dialogRef.close();

                _this4.toast.show("Edit not allowed for this item!\nThis Item has assigned Payment.", {
        ...
        value: function _delete(row) {
          ...
          this.apiService.loadAll('pay').subscribe(function (result) {
            _this5.payments = result;

            if (result.filter(function (x) {
              return x.ref_inv == row.id;
            }).length > 0) {
              _this5.toast.show("Delete not allowed for this item!\nThis Item has assigned Payment.", {
                classname: 'bg-danger text-light',
                delay: 5000
              });
            } else {
              if (confirm('Are sure to delete?')) {
                _this5.apiService["delete"](row.id, 'inv').subscribe(function (result) {
                  _this5.deleteUI(row);
                });
              }
            }
        ...
        key: "findCsutomer",
        value: function findCsutomer(id) {
          var c = this.customers.filter(function (x) {
            return x.id == id;
          })[0];
    ...
    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MatPaginator"], {
      "static": false
    }), __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatPaginator"])], InvoiceComponent.prototype, "paginator", void 0);
    ...
    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSort"], {
      "static": false
    }), __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSort"])], InvoiceComponent.prototype, "msort", void 0);

    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(), __metadata("design:type", Object)], InvoiceComponent.prototype, "invoices", void 0);

    InvoiceComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      selector: 'app-invoice',
      template: __importDefault(__webpack_require__(
      /*! raw-loader!./invoice.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/invoice/invoice.component.html"))["default"],
      ...
      "./src/app/components/invoice/invoice.component.css"))["default"]]
    }), __metadata("design:paramtypes", [_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"], _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"], _shared_toast_toast_service__WEBPACK_IMPORTED_MODULE_5__["ToastService"]])], InvoiceComponent);

    var CuDialog = /*#__PURE__*/function () {
      function CuDialog(apiService, dialogRef, dData, _formBuilder, _snackBar) {
        _classCallCheck(this, CuDialog);
      ...
      _createClass(CuDialog, [{
        ...
        key: "calTotal",
        value: function calTotal() {
          var count = 0;
          this.invoiceItems.forEach(function (element) {
        ...
        key: "invOperation",
        value: function invOperation(data) {
          var _this7 = this;
          ...
          if (data) {
            console.log('update');
            this.apiService.update(data.id, this.invoiceFC.value, 'inv').subscribe(function (result) {
              if (result.error) {
                console.log(result.error);
              } else {
                _this7.dialogRef.close(result);
              }
            });
          } else {
            this.apiService.create(this.invoiceFC.value, 'inv').subscribe(function (result) {
              if (result.error) {
                console.log(result.error);
              } else {
                _this7.invoice = result;
              }
            });
          }
        }
        ...
        key: "getLastInvNum",
        value: function getLastInvNum() {
          var _this8 = this;

          this.apiService.loadAll('last_inv').subscribe(function (result) {
            if (result.invoice) {
              _this8.invNumber = 'Invoice-' + (result.invoice + 1);
            } else {
              _this8.invNumber = 'Invoice-' + 1;
            }

            _this8.invoiceFC.controls['inv_number'].disable();

            _this8.invoiceFC.controls['total_price'].disable();

            _this8.invoiceFC.controls['balance'].disable();
          });
        }
      }, {
        key: "createItem",
        value: function createItem() {
          ...
          this.apiService.create(this.itemsFC.value, 'itm').subscribe(function (result) {
            if (result.error) {
              _this9.errors = result.error;
            } else {
              _this9.invoiceItems.push(result);

              _this9.calTotal();

              _this9.itemSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](_this9.invoiceItems);

              _this9.itemsFC.reset();
            }

            console.log(_this9.errors);
          });
        }
      }, {
        key: "removeItem",
        value: function removeItem(data) {
          ...
          if (confirm('Are sure to delete?')) {
            this.apiService["delete"](data.id, 'itm').subscribe(function (result) {
              _this10.invoiceItems = _this10.invoiceItems.filter(function (item) {
                return item !== data;
              });
              _this10.itemSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](_this10.invoiceItems);

              _this10._snackBar.openFromComponent(SnakComponent, {
                duration: 2000
              });
            });
          }
        ...
        key: "finishInvoice",
        value: function finishInvoice(inv) {
          this.calTotal();
    ...
    CuDialog.ctorParameters = function () {
      return [{
        type: _api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]
      }, {
    ...
    CuDialog = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      selector: 'cu-dialog',
      template: __importDefault(__webpack_require__(
      /*! raw-loader!./cu-dialog.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/invoice/cu-dialog.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./invoice.component.css */
      "./src/app/components/invoice/invoice.component.css"))["default"]]
    }), __param(2, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"])), __metadata("design:paramtypes", [_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"], _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"], Object, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"]])], CuDialog);
  ...
  /***/
  function srcAppComponentsInvoiceInvoiceModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "InvoiceRoutes", function () {
    ...
    InvoiceModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
      declarations: [_invoice_component__WEBPACK_IMPORTED_MODULE_3__["InvoiceComponent"], _invoice_component__WEBPACK_IMPORTED_MODULE_3__["CuDialog"], _invoice_component__WEBPACK_IMPORTED_MODULE_3__["SnakComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(InvoiceRoutes)],
      entryComponents: [_invoice_component__WEBPACK_IMPORTED_MODULE_3__["CuDialog"], _invoice_component__WEBPACK_IMPORTED_MODULE_3__["SnakComponent"]],
      providers: [{
...
//# sourceMappingURL=components-invoice-invoice-module-es5.js.map